...
import { PRIVACY_SECTIONS, PRIVACY_LAST_UPDATED } from '../../data/legal/privacy';
    ...
    <div className="min-h-screen bg-surface">
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-headline-lg text-text-primary font-bold">Política de Privacidad</h1>
            <p className="text-label-sm text-text-muted">Última actualización: {PRIVACY_LAST_UPDATED}</p>
          </div>
        </div>
        ...
        <div className="bg-surface-card rounded-xl p-4 border border-border-subtle">
          <p className="text-body-md text-text-primary">
            En ServiciosHogar Reynosa, la protección de tus datos personales es prioridad.
