...
const CONFIG = {
    ...
    DRIVE_CLIENT_ID: '136483197929-57qnp2q8q2fkt3i2aeae6ratk9scn9cl.apps.googleusercontent.com',  // OAuth 2.0 Client ID (SuitCampanas Web Local)
    DRIVE_APP_ID: '136483197929',                               // Google Cloud Project Number
    PROMPTS_API: '/api/prompts/'                                // Endpoint para prompts desde Prompts_IA
};
